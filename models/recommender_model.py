    ...
    def build_model(self):
        ...
        try:
            if self.model_type == 'random_forest':
                ...
                print(f"RandomForest model built with parameters: {self.model_params}")
                ...
                print(f"Neural Network model built with parameters: {self.model_params}")
            
            else:
                raise ValueError("Unsupported model type. Use 'random_forest' or 'neural_network'.")
        ...
        try:
            if self.model_type == 'random_forest':
                ...
                with mlflow.start_run():
                    ...
                    print(f"RandomForest Model trained successfully. Train MSE: {train_mse}, Test MSE: {test_mse}")
                ...
                with mlflow.start_run():
                    ...
                    # Log the model
                    mlflow.pytorch.log_model(self.model, "neural_network_model")

                    print(f"Neural Network Model trained successfully. Train MSE: {train_mse}, Test MSE: {test_mse}")
            else:
                raise ValueError("Unsupported model type for training. Use 'random_forest' or 'neural_network'.")
        except Exception as e:
    ...
    def evaluate_model(self, data: pd.DataFrame, target: str) -> Dict[str, float]:
        ...
        try:
            if self.model_type == 'random_forest':
                ...
                raise ValueError("Unsupported model type for evaluation. Use 'random_forest' or 'neural_network'.")
        except Exception as e:
